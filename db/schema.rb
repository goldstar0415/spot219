...
ActiveRecord::Schema.define(version: 20160704081820) do
  ...
  add_index "business_hours", ["place_id"], name: "index_business_hours_on_place_id", using: :btree
  ...
  add_foreign_key "business_hours", "places"
